...
declare namespace fgui {
    class Events {
        ...
        static RIGHT_CLICK_ITEM: string;
        static DOUBLE_CLICK_ITEM: string;
        ...
        static GEAR_STATE_UPDATE: string;
...
declare namespace fgui {
    class GObject {
        ...
        set y(value: number);
        get noPivotX(): number;
        set noPivotX(Value: number);
        get noPivotY(): number;
        set noPivotY(Value: number);
        ...
        setPivot(xv: number, yv?: number, asAnchor?: boolean, ChangePos?: boolean): void;
        get pivotAsAnchor(): boolean;
        internalSetPivot(xv: number, yv: number, asAnchor: boolean): void;
...
declare namespace fgui {
    class GComponent extends GObject {
        ...
        SetHitTextMask(HitTestData: PixelHitTestData | GGraph, OffsetX: number, OffsetY: number): boolean;
        get margin(): Margin;
        ...
        createScroll(): ScrollPane;
        setupOverflow(overflow: number): void;
        protected handleSizeChanged(): void;
        protected handleGrayedChanged(): void;
        handleControllerChanged(c: Controller): void;
...
declare namespace fgui {
    class GButton extends GComponent {
        ...
        get buttonController(): Controller;
...
declare namespace fgui {
    class GComboBox extends GComponent {
        ...
        handleControllerChanged(c: Controller): void;
        protected updateSelectionController(): void;
        getProp(index: number): any;
        setProp(index: number, value: any): void;
        protected constructExtension(buffer: ByteBuffer): void;
        initExtension(DropDown: GComponent): boolean;
        disposeExtension(): void;
        setup_afterAdd(buffer: ByteBuffer, beginPos: number): void;
        protected showDropdown(OnlyUpdate?: boolean): void;
        UpdateDropdown(): void;
        protected __popupWinClosed(): void;
        protected __clickItem(itemObject: GObject, evt: Laya.Event): void;
        protected __clickItem2(index: number, evt: Laya.Event): void;
        protected __rollover(): void;
        protected __rollout(): void;
        protected __mousedown(evt: Laya.Event): void;
        protected __mouseup(evt: Laya.Event): void;
    }
}
declare namespace fgui {
    enum GGGraphType {
    ...
    class GGraph extends GObject {
        ...
        set type(Value: GGGraphType);
        get polygonPoints(): number[];
        set polygonPoints(Values: number[]);
        get lineSize(): number;
...
declare namespace fgui {
    class GList extends GComponent {
        ...
        get columnGap(): number;
        set columnGap(value: number);
        get align(): fgui.AlignType;
        set align(value: fgui.AlignType);
        get verticalAlign(): fgui.VertAlignType;
        set verticalAlign(value: fgui.VertAlignType);
        ...
        private __clickItem;
        private __rightClickItem;
        private __doubleClickItem;
...
declare namespace fgui {
    class GObjectPool {
        ...
        addObject(url: string, obj: GObject): void;
    }
}
declare namespace fgui {
    class GLoader extends GObject {
        ...
        static ExtendLoader: (url: string) => Promise<fgui.Image | fgui.MovieClip>;
        constructor();
        protected createDisplayObject(): void;
        dispose(): void;
        get url(): string;
...
declare namespace fgui {
    class GTextField extends GObject {
        ...
        get align(): AlignType;
        set align(value: AlignType);
        get valign(): VertAlignType;
        set valign(value: VertAlignType);
        get leading(): number;
...
declare namespace fgui {
    class GTree extends GList {
        ...
        _updateNode(node: GTreeNode): void;
...
declare namespace fgui {
    class ScrollPane {
        ...
        get displayOnLeft(): boolean;
        set displayOnLeft(Value: boolean);
        get displayInDemand(): boolean;
        set displayInDemand(Value: boolean);
        get pageMode(): boolean;
        set pageMode(Value: boolean);
        get inertia(): boolean;
        set inertia(Value: boolean);
        get containerClip(): boolean;
        set containerClip(Value: boolean);
        get floating(): boolean;
        set floating(Value: boolean);
        get clipMargin(): boolean;
        set clipMargin(Value: boolean);
        get scrollBarDisplayType(): ScrollBarDisplayType;
        set scrollBarDisplayType(Value: ScrollBarDisplayType);
        set vScrollBarRes(Value: string);
        set hScrollBarRes(Value: string);
        set headerRes(Value: string);
        set footerRes(Value: string);
        get scrollBarMargin(): Margin;
        dispose(): void;
        get owner(): GComponent;
        get hzScrollBar(): GScrollBar;
        set hzScrollBar(Value: GScrollBar);
        get vtScrollBar(): GScrollBar;
        set vtScrollBar(Value: GScrollBar);
        get header(): GComponent;
        set header(Value: GComponent);
        get footer(): GComponent;
        set footer(Value: GComponent);
...
declare namespace fgui {
    class GearBase {
        ...
        static enableStateUpdateEvent: boolean;
        ...
        set tweenConfig(Value: GearTweenConfig);
        setup(buffer: ByteBuffer): void;
...
declare namespace fgui {
    class GearAnimationValue {
        playing: boolean;
        frame: number;
        constructor(playing?: boolean, frame?: number);
        toString(): string;
    }
    class GearAnimation extends GearBase {
        ...
        constructor(owner: GObject);
        protected init(): void;
        addStatusDirect(pageId: string, playing: boolean, frame: number): void;
        protected addStatus(pageId: string, buffer: ByteBuffer): void;
        apply(): void;
        updateState(): void;
    }
...
declare namespace fgui {
    class GearColorValue {
        color: string;
        strokeColor: string;
        constructor(color?: string, strokeColor?: string);
        toString(): string;
    }
    class GearColor extends GearBase {
        ...
        constructor(owner: GObject);
        protected init(): void;
        addStatusDirect(pageId: string, color: string, strokeColor: string): void;
        protected addStatus(pageId: string, buffer: ByteBuffer): void;
        apply(): void;
        updateState(): void;
    }
...
declare namespace fgui {
    class GearFontSize extends GearBase {
        ...
        constructor(owner: GObject);
        protected init(): void;
        addStatusDirect(pageId: string, FontSize: number): void;
        protected addStatus(pageId: string, buffer: ByteBuffer): void;
        apply(): void;
        updateState(): void;
    }
...
declare namespace fgui {
    class GearIcon extends GearBase {
        ...
        constructor(owner: GObject);
        protected init(): void;
        addStatusDirect(pageId: string, icon: string): void;
        protected addStatus(pageId: string, buffer: ByteBuffer): void;
        apply(): void;
        updateState(): void;
    }
...
declare namespace fgui {
    class GearLookValue {
        ...
        grayed: boolean;
        touchable: boolean;
        constructor(alpha?: number, rotation?: number, grayed?: boolean, touchable?: boolean);
    }
    class GearLook extends GearBase {
        ...
        constructor(owner: GObject);
        protected init(): void;
        addStatusDirect(pageId: string, alpha: number, rotation: number, grayed: boolean, touchable: boolean): void;
        protected addStatus(pageId: string, buffer: ByteBuffer): void;
        apply(): void;
...
declare namespace fgui {
    ...
    class GearSize extends GearBase {
        ...
        constructor(owner: GObject);
        init(): void;
        addStatusDirect(pageId: string, width: number, height: number, scaleX: number, scaleY: number): void;
        addStatus(pageId: string, buffer: ByteBuffer | GearSizeValue): void;
        apply(): void;
        private __tweenUpdate;
        private __tweenComplete;
        updateState(): void;
...
declare namespace fgui {
    class GearText extends GearBase {
        ...
        constructor(owner: GObject);
        protected init(): void;
        addStatusDirect(pageId: string, text: string): void;
        protected addStatus(pageId: string, buffer: ByteBuffer): void;
        apply(): void;
        updateState(): void;
    }
...
declare namespace fgui {
    class GearXYValue {
        ...
        px: number;
        py: number;
        constructor(x?: number, y?: number, px?: number, py?: number);
    }
    class GearXY extends GearBase {
        ...
        constructor(owner: GObject);
        protected init(): void;
        addStatusDirect(pageId: string, x: number, y: number, px: number, py: number): void;
        protected addStatus(pageId: string, buffer: ByteBuffer): void;
