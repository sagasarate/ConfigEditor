...
export class CSmartValue {
    ...
    public toLong(): Long {
        ...
        switch (this.GetValueType()) {
            case SMART_VALUE_TYPE.VT_CHAR:
                return Long.fromNumber(dv.getInt8(1), false);
            case SMART_VALUE_TYPE.VT_UCHAR:
                return Long.fromNumber(dv.getUint8(1), true);
            case SMART_VALUE_TYPE.VT_SHORT:
                return Long.fromNumber(dv.getInt16(1, true), false);
            case SMART_VALUE_TYPE.VT_USHORT:
                return Long.fromNumber(dv.getUint16(1, true), true);
            case SMART_VALUE_TYPE.VT_INT:
                return Long.fromNumber(dv.getInt32(1, true), false);
            case SMART_VALUE_TYPE.VT_UINT:
                return Long.fromNumber(dv.getUint32(1, true), true);
            case SMART_VALUE_TYPE.VT_BIGINT:
                return Long.fromBits(dv.getUint32(1, true), dv.getUint32(5, true), false);
            case SMART_VALUE_TYPE.VT_UBIGINT:
                return Long.fromBits(dv.getUint32(1, true), dv.getUint32(5, true), true);
            case SMART_VALUE_TYPE.VT_FLOAT:
                return Long.fromNumber(dv.getFloat32(1, true), false);
            case SMART_VALUE_TYPE.VT_DOUBLE:
                return Long.fromNumber(dv.getFloat64(1, true), false);
            case SMART_VALUE_TYPE.VT_BOOL:
                return Long.fromNumber(dv.getInt8(1), true);
        }
        return Long.ZERO;
    }
    ...
    public static fromLong(Value: Long): CSmartValue {
        let SmartValue = new CSmartValue(Value.unsigned ? SMART_VALUE_TYPE.VT_UBIGINT : SMART_VALUE_TYPE.VT_BIGINT, 0);
        SmartValue.SetValue(Value);
        return SmartValue;
    }
    ...
    public SetValue(Value: any): boolean {
        if (this.m_pData instanceof Uint8Array) {
            if (typeof (Value) == "number") {
                ...
                switch (this.GetValueType()) {
                    case SMART_VALUE_TYPE.VT_CHAR:
                        dv.setInt8(1, Value.toSigned().toNumber());
                        return true;
                    case SMART_VALUE_TYPE.VT_UCHAR:
                        dv.setUint8(1, Value.toUnsigned().toNumber());
                        return true;
                    case SMART_VALUE_TYPE.VT_SHORT:
                        dv.setInt16(1, Value.toSigned().toNumber(), true);
                        return true;
                    case SMART_VALUE_TYPE.VT_USHORT:
                        dv.setUint16(1, Value.toUnsigned().toNumber(), true);
                        return true;
                    case SMART_VALUE_TYPE.VT_INT:
                        dv.setInt32(1, Value.toSigned().toNumber(), true);
                        return true;
                    case SMART_VALUE_TYPE.VT_UINT:
                        dv.setUint32(1, Value.toUnsigned().toNumber(), true);
                        return true;
                    case SMART_VALUE_TYPE.VT_BIGINT:
                        dv.setUint32(1, Value.getLowBitsUnsigned(), true);
                        dv.setUint32(5, Value.getHighBitsUnsigned(), true);
                        return true;
                    case SMART_VALUE_TYPE.VT_UBIGINT:
                        dv.setUint32(1, Value.getLowBitsUnsigned(), true);
                        dv.setUint32(5, Value.getHighBitsUnsigned(), true);
                        return true;
                    case SMART_VALUE_TYPE.VT_FLOAT:
                        dv.setFloat32(1, Value.toNumber(), true);
                        return true;
                    case SMART_VALUE_TYPE.VT_DOUBLE:
                        dv.setFloat64(1, Value.toNumber(), true);
                        return true;
                    case SMART_VALUE_TYPE.VT_BOOL:
                        dv.setInt8(1, Value.toNumber() ? 1 : 0);
                        return true;
                }
            }
            else if (Value instanceof Uint8Array) {
...
export class CSmartStruct {
    ...
    public AddMemberLong(ID: number, Value: Long): boolean {
        let Type = Value.unsigned ? SMART_VALUE_TYPE.VT_UBIGINT : SMART_VALUE_TYPE.VT_BIGINT;
...
export class CSmartArray {
    ...
    public GetArrayLong(Array: Long[]): boolean {
        if (this.GetLength() > 0) {            
            if (this.m_ElementSize > 0) {
                let Value = CSmartValue.NULL;
    ...
    public AddMemberLong(Value: Long): boolean {
        let ValueType = Value.unsigned ? SMART_VALUE_TYPE.VT_UBIGINT : SMART_VALUE_TYPE.VT_BIGINT;
    ...
    public AddArrayLong(Array: Long[]): boolean {
        if (Array.length > 0) {
